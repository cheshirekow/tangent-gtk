 ...
 * Cairo::RefPtr<Cairo::Context>&anslate. In other words, the translation of the
...
void translate(const Cairo::RefPtr<Cairo::Context>& cr,
 ...
 */
template <typename Derived>
void user_to_device(const Cairo::RefPtr<Cairo::Context>& cr,
                    Eigen::MatrixBase<Derived>* v);

inline void user_to_device(const Cairo::RefPtr<Cairo::Context>& cr,
 ...
 */
template <typename Derived>
void move_to(const Cairo::RefPtr<Cairo::Context>& cr,
             const Eigen::MatrixBase<Derived>& v);
 ...
 */
template <typename Derived>
void line_to(const Cairo::RefPtr<Cairo::Context>& cr,
             const Eigen::MatrixBase<Derived>& v);
...
void curve_to(const Cairo::RefPtr<Cairo::Context>& cr,
 ...
 */
template <typename Derived>
void arc(const Cairo::RefPtr<Cairo::Context>& cr,
 ...
 */
template <typename Derived>
void arc_negative(const Cairo::RefPtr<Cairo::Context>& cr,
 ...
 */
template <typename Derived>
void rel_move_to(const Cairo::RefPtr<Cairo::Context>& cr,
                 const Eigen::MatrixBase<Derived>& v);
 ...
 */
template <typename Derived>
void rel_line_to(const Cairo::RefPtr<Cairo::Context>& cr,
                 const Eigen::MatrixBase<Derived>& v);
 ...
 */
template <typename Derived1, typename Derived2, typename Derived3>
void rel_curve_to(const Cairo::RefPtr<Cairo::Context>& cr,
...
void rectangle(const Cairo::RefPtr<Cairo::Context>& cr,
               const Eigen::MatrixBase<Derived1>& x,
               const Eigen::MatrixBase<Derived2>& s);

template <typename Derived>
void circle(const Cairo::RefPtr<Cairo::Context>& cr,
